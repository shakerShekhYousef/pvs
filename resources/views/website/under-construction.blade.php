...
<div class="construction">
    <div class="container">
        <div class="box mb-5">
            <div class="row">
                <div class="col-lg-12">
                    <h1>New Pages Under Construction</h1>
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                         width="100.001px" height="70px" viewBox="0 0 100 68"
                         style="filter: invert(32%) sepia(8%) saturate(5646%) hue-rotate(188deg) brightness(94%) contrast(95%);">
                        <g id="large">
                            <g>
		...
		C84.573,16.331,86.05,20.549,84.365,24.062z" fill="none" stroke="#E43"/>
                    ...
                    <p>
                        ...
                        We are currently initializing our new pages.
                    </p>
                    <p>
                        It's okay, we're excited too!
                    </p>
                    <br><br>
                    <a href="{{route('front.home')}}" class="text-uppercase button-undercon">GO HOME</a>
                </div>
            </div>
        </div>
    </div>
